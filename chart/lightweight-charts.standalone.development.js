/*!
 * @license
 * TradingView Lightweight Charts v4.0.0-dev+202208230345
...
(function () {
    ...
    class PriceAxisRendererOptionsProvider {
        constructor(chartModel) {
            this._private__rendererOptions = {
                ...
                _internal_tickLength: 5 /* TickLength */,
    ...
    styleGetter, finishStyledArea) {
        ...
        for (let i = visibleRange.from + 1; i < visibleRange.to; ++i) {
            ...
            if (lineType !== 1 /* WithSteps */ && itemStyle !== currentStyle) {
                changeStyle(itemStyle, currentItem);
                ctx.moveTo(currentItem._internal_x, currentItem._internal_y);
            }
        }
        if (currentStyleFirstItem !== currentItem || currentStyleFirstItem === currentItem && lineType === 1 /* WithSteps */) {
            finishStyledArea(ctx, currentStyle, currentStyleFirstItem, currentItem);
        }
    }
    ...
    class PaneRendererHistogram {
        ...
        _internal_draw(ctx, pixelRatio, isHovered, hitTestData) {
            ...
            for (let i = this._private__data._internal_visibleRange.from; i < this._private__data._internal_visibleRange.to; i++) {
                ...
                let pos;
                pos = 'XL' + current._internal_left.toString() + ' YT' + top.toString() + ' W' + (current._internal_right - current._internal_left + 1).toString() + ' H' + (bottom - top).toString();
    ...
    class PriceAxisWidget {
        constructor(pane, options, rendererOptionsProvider, side) {
            ...
            this._private__pane = pane;
            this._private__layoutOptions = options;
        ...
        _internal_baseFont() {
            return makeFont(this._internal_fontSize(), this._private__layoutOptions.fontFamily);
        }
        ...
        _private__drawTickMarks(ctx, pixelRatio) {
            ...
            ctx.fillStyle = (_b = (_a = this._private__priceScale) === null || _a === void 0 ? void 0 : _a._internal_options().textColor) !== null && _b !== void 0 ? _b : this._private__layoutOptions.textColor;
